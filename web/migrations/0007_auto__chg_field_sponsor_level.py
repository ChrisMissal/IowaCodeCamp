...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sponsor.level'
        db.alter_column('web_sponsor', 'level', self.gf('django.db.models.fields.IntegerField')())


    def backwards(self, orm):
        
        # Changing field 'Sponsor.level'
        db.alter_column('web_sponsor', 'level', self.gf('django.db.models.fields.CharField')(max_length=2))
