...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('web_speaker', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=100, null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Speaker.slug'
        db.delete_column('web_speaker', 'slug')
